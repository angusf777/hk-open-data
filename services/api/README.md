...
Fastify service for the self-hosted data access and API health REST interface, audited
administration, and optional webhook delivery. It uses
...
kill switches are included. Included source definitions remain inactive until the person running
the toolkit records the required review and enables them.
