...
const messages = {
  en: {
    ...
    summary: (official: number, external: number, mcp: number) =>
      `Explore ${official} official sources, ${external} external services and ${mcp} MCP candidates.`,
    ...
    results: (count: number) => `${count} ${count === 1 ? "source" : "sources"}`,
    downloadJson: "Download JSON",
    downloadCsv: "Download CSV",
    noResults: "No sources match those filters.",
    showMore: "Show more sources",
    provider: "Provider",
    type: "Type",
    protocol: "Protocol",
    auth: "Auth",
    ...
    toolkitLink: "Browse provider files and endpoints",
    legal:
  ...
  "zh-Hant": {
    ...
    ambiguity: "仍有待釐清事項",
    restriction: "已註明限制",
    results: (count: number) => `${count} 個來源`,
    downloadJson: "下載 JSON",
    downloadCsv: "下載 CSV",
    noResults: "沒有符合這些篩選條件的來源。",
    showMore: "顯示更多來源",
    provider: "供應者",
    type: "類型",
    protocol: "協定",
