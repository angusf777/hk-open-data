...
const messages = {
  en: {
    ...
    about: "About",
    locale: "繁中",
    notice: "Independent community project. Upstream terms always control.",
    ...
    ambiguity: "Ambiguity identified",
    restriction: "Restriction identified",
    ...
    evidenceBoundary:
      "This project records evidence, not permission. Check current provider terms before commercial use, caching or redistribution.",
    projectNote:
  ...
  "zh-Hant": {
    ...
    providerLinks: "供應者連結",
    evidenceBoundary:
      "本項目記錄證據，而非授予許可。商業使用、快取或再分發前，請核實供應者的現行條款。",
...
const localizedValues: Record<string, [string, string]> = {
  ...
  "not-reviewed": ["Not reviewed", "尚未審查"],
  "ambiguity-identified": ["Ambiguity identified", "已識別不確定性"],
  "restriction-identified": ["Restriction identified", "已識別限制"],
